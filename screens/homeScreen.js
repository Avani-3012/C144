            ...
            <View style={styles.container}>
              ...
              <View style={styles.subBottomContainer}>
                  <View style={styles.upperBottomContainer}>
                    ...
                    <Text style={styles.title}>{`${release_date.split("-")[0]} | ${duration}`}</Text>
                    </View>
                    ...
                    <View style={styles.lowerBottomConatiner}>
...
const styles = StyleSheet.create({ 
  ...
  posterImage: { width: "60%", height: "90%", resizeMode: "stretch", borderRadius: RFValue(30), 
  ...
  buttonCotainer: { justifyContent: "center", alignItems: "center" },
   button: { width: RFValue(160), height: RFValue(50), borderRadius: RFValue(20), 
    justifyContent: "center", alignItems: "center", borderWidth: 1, marginTop: RFValue(15) },
